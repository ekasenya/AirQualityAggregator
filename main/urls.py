...
urlpatterns = [
    ...
    url(r'^service/all/(?P<substance_id>[0-9]+)$', views.SubstanceServicesDetailView.as_view(),
        name='substance-det-services'),
    url(r'^service/all/(?P<substance_id>[0-9]+)$', views.SubstanceStationsDetailView.as_view(),
